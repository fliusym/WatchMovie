...
{
    public class RTInTheaterMoviesGroup : WMMovieGroupCommon<WMMoviesViewModel.RTInTheaterMovie>
    {
        public RTInTheaterMoviesGroup(string uniqueId, string title, string imagePath)
        ...
        protected override void AddItemInternal<U>(U response)
        {
            ...
            if (movies != null)
            {
                ...
                {
                    Items.Clear();
                    foreach (var mi in movies.Movies.Select(t => new RTInTheaterMovie(
                        t.Id,
                        t.Title,
                        t.MPAARating,
